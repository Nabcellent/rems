...
const Index = ({ units }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            Inertia.post(route('dashboard.units.store'), values, {
    ...
    const handleDelete = unit => {
        if (unit) {
            MySwal.fire({
                ...
                if (result.isConfirmed) Inertia.delete(route('dashboard.units.destroy', { unit: unit.id }));
            });
        }
    };
            ...
            <Row>
                <Col className="col-12">
                    <Card>
                                ...
                                Cell: ({ row }) => {
                                    return (
                                        <>
                                            ...
                                            <Link
                                                href={route('dashboard.units.show', { unit: row.original.id })}>
                        ...
                        ]} data={units} onCreateRow={handleCreate}/>
                    </Card>
                </Col>
            </Row>

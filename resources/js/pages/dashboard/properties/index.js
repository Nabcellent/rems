...
const Index = ({ properties }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            Inertia.post(route('dashboard.properties.store'), values, {
    ...
    const handleUpdate = property => {
        ...
        formik.setValues(property, true);
        setShowModal(true);
    };
    ...
    const handleDelete = property => {
        if (property) {
            MySwal.fire({
                ...
                if (result.isConfirmed) Inertia.delete(route('dashboard.properties.destroy', { property: property.id }));
            });
        }
    };
            ...
            <Row>
                <Col className="col-12">
                    <Card>
                        ...
                        ]} data={properties} onCreateRow={handleCreate}/>
                    </Card>
                </Col>
            </Row>
